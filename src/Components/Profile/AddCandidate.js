...
export default function AddCandidate() {
   ...
   const TMAccess = ["Admin", "Manager", "Teamlead"].includes(employeeType);
                       ...
                       renderInput={(params) => (
                         <TextField
                           ...
                           InputProps={{
                             ...params.InputProps,
                             type: "search",
                             required: candidate.companyId?.length === 0,
                           }}
                           required={["WD", "TAC", "GOOD"].includes(
                       ...
                       renderInput={(params) => (
                         <TextField
                           ...
                           InputProps={{
                             ...params.InputProps,
                             type: "search",
                             required: candidate.roleId?.length === 0,
                           }}
                           required={["WD", "TAC", "GOOD"].includes(
                             candidate.l1Assessment,
                           )}
